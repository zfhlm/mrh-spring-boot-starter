 ...
 * @param <E>
 */
public class JpaNotEqualCondition<E> implements JpaCondition<E> {

	private String singular;

	private String otherSingular;

	public JpaNotEqualCondition(String singular, String otherSingular) {
		super();
	...
	public Predicate toPredicate(Root<E> root, CriteriaBuilder criteriaBuilder) {
		...
		return criteriaBuilder.notEqual(path, otherPath);
	}
